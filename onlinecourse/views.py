...
# Submit view: creates an exam submission record for the user's course enrollment
...
# Exam result view: checks every question and computes the learner's total score
def show_exam_result(request, course_id, submission_id):
    ...
    grade = round(total_score * 100 / max_score) if max_score > 0 else 0
